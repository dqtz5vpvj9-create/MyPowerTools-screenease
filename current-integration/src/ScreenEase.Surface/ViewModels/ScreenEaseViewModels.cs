...
public sealed partial class ScreenEaseViewModel : MyPowerTools.AvaloniaSdk.ToolSurfacePageViewModel, IDisposable
{
    ...
    public ScreenEaseViewModel(
        ...
        : base("ScreenEase", "护眼模式与休息提醒", MyPowerTools.AvaloniaSdk.ToolSurfaceState.Ready)
    {
        Snapshot = snapshot;
        ...
        SaveScheduleCommand = new MptAsyncRelayCommand(SaveScheduleAsync, () => !IsBusy);
        StartReminderCommand = new MptAsyncRelayCommand(StartReminderAsync, CanStartReminder);
        PauseReminderCommand = new MptAsyncRelayCommand(PauseReminderAsync, CanPauseReminder);
        ResumeReminderCommand = new MptAsyncRelayCommand(ResumeReminderAsync, CanResumeReminder);
        ResetReminderCommand = new MptAsyncRelayCommand(ResetReminderAsync, CanResetReminder);
        ToggleDiagnosticsCommand = new MptAsyncRelayCommand(() =>
        {
            DiagnosticsExpanded = !DiagnosticsExpanded;
            return Task.CompletedTask;
        });
        SaveAdvancedCommand = new MptAsyncRelayCommand(SaveAdvancedAsync, () => !IsBusy);
        SaveOverlayCommand = new MptAsyncRelayCommand(SaveOverlayAsync, () => !IsBusy);
        ImportLegacyCommand = new MptAsyncRelayCommand(ImportLegacyAsync, () => !IsBusy);
        OpenHotkeySettingsCommand = new MptAsyncRelayCommand(_openHotkeySettings, () => !IsBusy);
