...
public sealed partial class ScreenEaseViewModel
{
    ...
    {
        ((MptAsyncRelayCommand)ToggleEyeCareCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)SaveModeCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)NewModeCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)ApplyCurrentCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)SaveReminderCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)SaveScheduleCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)SaveAdvancedCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)SaveOverlayCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)ImportLegacyCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)OpenHotkeySettingsCommand).NotifyCanExecuteChanged();
        NotifyTimerCommands();
    }
    ...
    {
        ((MptAsyncRelayCommand)StartReminderCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)PauseReminderCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)ResumeReminderCommand).NotifyCanExecuteChanged();
        ((MptAsyncRelayCommand)ResetReminderCommand).NotifyCanExecuteChanged();
    }
}
